...
export var Modal = function (props) {
    ...
    return (_jsx(Portal, { children: _jsx("div", __assign({ className: classNames(cls.Modal, mods, [className, theme, 'app_modal']) }, { children: _jsx("div", __assign({ role: "presentation", className: cls.overlay, onClick: closeHandler }, { children: _jsx("div", __assign({ role: "presentation", className: cls.content, onClick: onContentClick }, { children: children })) })) })) }));
};
